...
public class HelloWorldEndpoint {
    ...
    @GET
    @Path("{id}")
    public Response getTodo(@PathParam("id") final String id) {
        final Todo todo = todoDAO.findById(id);
    ...
    public Response update(@PathParam("id") final String id, final Todo todo) {
        final Todo updateTodo = todoDAO.findById(id);
    ...
    public Response delete(@PathParam("id") final String id) {
        final Todo getTodo = todoDAO.findById(id);
